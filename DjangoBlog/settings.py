...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['https://github.com/JoeJoeyMa', '127.0.0.1', 'example.com']
...
SITE_NAME = 'JoeJoey.Ma'
SITE_URL = 'https://github.com/JoeJoeyMa'
SITE_DESCRIPTION = 'To change is to be better to change often is to change perfect'
SITE_SEO_DESCRIPTION = 'Blog'
...
OAHUTH = {
    'sina': {
        ...
        'callbackurl': 'https://github.com/JoeJoeyMa'
    },
    'google': {
...
SITE_ID = 1
BAIDU_NOTIFY_URL = "http://data.zz.baidu.com"
